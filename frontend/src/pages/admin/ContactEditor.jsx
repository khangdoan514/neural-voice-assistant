  ...
  return (
    <motion.div className="w-full" variants={fadeInUp} initial="hidden" animate="visible">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h2 className="font-label text-xl text-nav-text">Contact Page Images</h2>
      </div>
      ...
      <motion.div className="space-y-6" variants={stagger} initial="hidden" animate="visible">
        <motion.div
          variants={fadeInUp}
          className="bg-gradient-to-br from-barn/90 to-charcoal/50 backdrop-blur-sm border border-rust/15 rounded-xl p-5 max-w-3xl shadow-[0_8px_24px_rgba(0,0,0,0.2)]"
        >
          ...
          <input
            ...
            className="w-full rounded-lg bg-charcoal border border-rust/20 px-3 py-2 text-base text-nav-text mb-3 focus:outline-none focus:border-rust focus:ring-1 focus:ring-rust/40"
          ...
          />
          <div className="mt-4 h-40 rounded overflow-hidden border border-rust/20 bg-charcoal/30">
            {contactBusinessHoursImage ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {contactPeople.map((person, index) => (
            <motion.div
              ...
              className="bg-gradient-to-br from-barn/90 to-charcoal/50 backdrop-blur-sm border border-rust/15 rounded-xl p-5 shadow-[0_8px_24px_rgba(0,0,0,0.2)]"
            >
              ...
              <input
                ...
                className="w-full text-sm text-muted file:mr-3 file:rounded file:border-0 file:bg-rust/20 file:px-3 file:py-1.5 file:text-rust file:font-label"
              />
              <div className="mt-4 h-32 rounded overflow-hidden border border-rust/20 bg-charcoal/30">
                {person.image ? (
