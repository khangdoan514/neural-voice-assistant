...
export default function ServiceArea() {
  ...
  return (
    <section className="grid gap-16 items-start py-20 px-20 bg-white border-t border-mid/20 border-b border-mid/20" style={{ gridTemplateColumns: "1fr 1fr" }}>
      {/* OpenStreetMap */}
        ...
        <div className="flex flex-col gap-4 mb-8">
          {locations.map((location) => (
            <div
              ...
              className={`
                border-l-3 pt-4 pb-4 pl-8 pr-8 
